...
| **응답 템플릿** | 자주 사용하는 응답 템플릿 관리, 변수 치환, 조걸 렌더링, 문의 유형별 추천 |
| **Git 연동** | GitHub/GitLab 이슈 연결/생성, 감사 로깅 |
...
| **응답 템플릿** | 변수 치환({{ticket.id}}, {{customer.name}} 등), 문의 유형별 추천, 사용 기록 감사 로그 |
| **Git 연동** | 이슈 연결/생성 시 감사 로깅, webhook 지원 |

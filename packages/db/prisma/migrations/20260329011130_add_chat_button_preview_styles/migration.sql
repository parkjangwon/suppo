...
INSERT INTO "new_ChatWidgetProfile" ("accentColor", "agentResponseTargetMinutes", "buttonBadgeText", "buttonBorderColor", "buttonBorderWidth", "buttonHoverEffect", "buttonImageUrl", "buttonLabel", "buttonShadow", "buttonShape", "buttonSize", "createdAt", "customerFollowupTargetMinutes", "enabled", "id", "isDefault", "name", "position", "showUnreadBadge", "updatedAt", "welcomeMessage", "welcomeTitle", "widgetKey") SELECT "accentColor", "agentResponseTargetMinutes", "buttonBadgeText", "buttonBorderColor", "buttonBorderWidth", "buttonHoverEffect", "buttonImageUrl", "buttonLabel", "buttonShadow", "buttonShape", "buttonSize", "createdAt", "customerFollowupTargetMinutes", "enabled", "id", "isDefault", "name", "position", "showUnreadBadge", "updatedAt", "welcomeMessage", "welcomeTitle", "widgetKey" FROM "ChatWidgetProfile";
...
INSERT INTO "new_ChatWidgetSettings" ("accentColor", "agentResponseTargetMinutes", "buttonBadgeText", "buttonBorderColor", "buttonBorderWidth", "buttonHoverEffect", "buttonImageUrl", "buttonLabel", "buttonShadow", "buttonShape", "buttonSize", "createdAt", "customerFollowupTargetMinutes", "enabled", "id", "position", "showUnreadBadge", "updatedAt", "welcomeMessage", "welcomeTitle", "widgetKey") SELECT "accentColor", "agentResponseTargetMinutes", "buttonBadgeText", "buttonBorderColor", "buttonBorderWidth", "buttonHoverEffect", "buttonImageUrl", "buttonLabel", "buttonShadow", "buttonShape", "buttonSize", "createdAt", "customerFollowupTargetMinutes", "enabled", "id", "position", "showUnreadBadge", "updatedAt", "welcomeMessage", "welcomeTitle", "widgetKey" FROM "ChatWidgetSettings";
